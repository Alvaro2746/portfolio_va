                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">$ <?php echo $venta->obtenerFacturacionMensual($mesActual=date("m"), $anioActual=date("Y")); ?> </div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">$ <?php echo $venta->obtenerFacturacionanual($anioActual=date("Y")); ?></div>
                    </div>
                    <div class="col-auto">

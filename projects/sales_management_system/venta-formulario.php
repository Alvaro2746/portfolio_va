    ...
    if(isset($_POST["btnGuardar"])){
        ...
        if(isset($_GET["id"]) && $_GET["id"] > 0){
            ...
            if($venta->cantidad <= $producto->cantidad){
                ...
                header("Location: venta-listado.php?msg=ingresado");
...
if(isset($_GET["id"]) && $_GET["id"] > 0){
    ...
    $fechaComoEntero = strtotime($venta->fecha);

    $anioaux = date("Y", $fechaComoEntero);
    $mesaux = date("m", $fechaComoEntero);
    $diaaux = date("d", $fechaComoEntero);
          ...
          <h1 class="h3 mb-4 text-gray-800">Venta</h1>
            ...
            <div class="row">
                ...
                <div class="col-6 form-group">
                    ...
                    <input type="text" class="form-control" name="txtTotal" id="txtTotal" disabled value="<?php echo $venta->total; ?>">
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
